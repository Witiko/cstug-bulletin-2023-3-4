...
\makeatletter
\ifcsbul@web
  \textcolor{Gray}{\fbox{\includegraphics[width=0.55\linewidth]{figs/talk-background.pdf}}}%
\else
  \textcolor{Gray}{\fbox{\includegraphics[width=0.55\linewidth]{figs/talk-background.png}}}%
\fi
\makeatother
\hfill
